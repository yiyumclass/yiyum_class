    ...
    <>
      ...
      <nav id="nav" style={{position: 'fixed', top: '0', left: '0', right: '0', zIndex: '60', color: '#201C17', transition: 'background 0.4s ease,color 0.4s ease,border-color 0.4s ease', borderBottom: '1px solid transparent'}}>
        <div style={{maxWidth: '1200px', margin: '0 auto', padding: '20px 40px', display: 'flex', alignItems: 'center', justifyContent: 'space-between'}}>
          <a href="#top" className="serif" style={{fontSize: '23px', letterSpacing: '0.01em'}}>이윰 홈</a>
      ...
      <header id="hero" style={{position: 'relative', background: '#F3EFE8', color: '#201C17', minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '140px 40px 90px', overflow: 'hidden'}}>
        ...
        <div style={{position: 'relative', zIndex: '1', maxWidth: '900px', margin: '0 auto', display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
          <div style={{overflow: 'hidden', marginBottom: '22px'}}><div style={{animation: 'fadeUp 0.9s cubic-bezier(0.16,1,0.3,1) 0.1s both', fontSize: '13px', letterSpacing: '0.32em', textTransform: 'uppercase', color: '#B85C38', fontWeight: '600'}}>이윰 SNS 수익화 클래스</div></div>
      ...
      <section style={{maxWidth: '1200px', margin: '0 auto', padding: '150px 40px 0'}}>
        ...
        <div style={{display: 'grid', gridTemplateColumns: '1fr 0.82fr', gap: '72px', alignItems: 'start'}}>
          ...
          <figure data-reveal="" data-reveal-delay="120" style={{margin: '0'}}>
            ...
            <figcaption style={{fontSize: '12px', letterSpacing: '0.14em', textTransform: 'uppercase', color: '#A79F92', marginTop: '14px'}}>이윰의 리빙 공간 — @yiyum_home</figcaption>
          </figure>
        </div>
        ...
        <div style={{marginTop: '110px'}}>
          ...
          <p data-reveal="" style={{fontSize: '16px', color: '#57514A', lineHeight: '1.8', margin: '36px 0 0', maxWidth: '640px'}}>제 수강생들도 <span style={{color: '#B85C38'}}>200~300명</span>의 적은 팔로워로 협찬과 원고료를 받았어요. 비결은 처음부터 <span style={{color: '#201C17', fontWeight: '600'}}>광고주가 원하는 계정으로 설계</span>하는 것뿐입니다.</p>
        </div>
      </section>
      ...
      <section style={{maxWidth: '1200px', margin: '0 auto', padding: '130px 40px 0'}}>
        ...
        <div data-reveal="" style={{display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', flexWrap: 'wrap', gap: '20px', marginBottom: '48px'}}>
      ...
      <section id="apply" style={{background: '#1B1815', color: '#EDE7DC', marginTop: '150px', padding: '130px 40px', scrollMarginTop: '0'}}>
        <div data-reveal="" style={{maxWidth: '820px', margin: '0 auto', textAlign: 'center'}}>
          ...
          <p style={{fontSize: '16px', color: '#9A9082', margin: '0 0 56px'}}>5개 챕터 · 총 32강 · 오픈카톡방 1:1 피드백 포함 · 1회 결제 평생 소장</p>
      ...
      <footer style={{maxWidth: '1200px', margin: '0 auto', padding: '56px 40px 80px'}}>
        <div style={{display: 'flex', alignItems: 'baseline', gap: '16px', marginBottom: '20px'}}>
          <span className="serif" style={{fontSize: '20px'}}>이윰 홈</span>
